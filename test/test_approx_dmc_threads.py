...
class TestApproxThreads(unittest.TestCase):
    def test_end_to_end(self):
        ...
        thread_palette = generate_palette(circle_image, original_image, output_file=False, debug=False)
        ...
        thread_palette = generate_palette(circle_image, original_image, debug=False)
